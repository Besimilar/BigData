package assign5;
 ...
 public class SpeciesConvergeReducer extends MapReduceBase implements Reducer<WritableComparable, Text, Text, Text> { 
   ...
   public void reduce(WritableComparable key, Iterator values, 
     ...
     //if (reduced){
	 	...
	 	// collect delta of PR between two MapReduce
