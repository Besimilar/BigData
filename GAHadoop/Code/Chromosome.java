...
class Chromosome {
	...
	static int target = 24; // default target num
	...
	public Chromosome(String chromo) { 
	...
	public final void scoreChromo(int target) {
		total = addUp();
		if (total == target) score = 2; // score should be 1/2 rather than 0
		
		//**********
		
		else score = Math.abs((double)1 / (target - total));
		//score = 1;
	}
